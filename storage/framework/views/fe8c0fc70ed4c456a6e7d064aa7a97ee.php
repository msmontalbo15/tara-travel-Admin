    ...
    <div class="min-h-full flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-sm">
            ...
            <div class="flex items-center gap-2.5 justify-center mb-8">
                <img src="<?php echo e(asset('assets/mobile/icon.png')); ?>" alt="Tara Travel" class="w-9 h-9 rounded-[11px] object-cover">
            ...
            <div class="bg-white rounded-xl shadow-xl shadow-black/20 p-7">
                ...
                <form method="POST" action="<?php echo e(route('admin.login.attempt')); ?>" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input id="email" name="email" type="email" required autofocus value="<?php echo e(old('email')); ?>"
...
<?php /**PATH D:\Spencer\Downloads\tara-admin\resources\views\admin\auth\login.blade.php ENDPATH**/ ?>