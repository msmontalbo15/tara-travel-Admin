...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('assets/mobile/icon.png')); ?>">
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> · Tara Travel Admin</title>
    ...
    <div class="min-h-full lg:flex" x-data="{ sidebarOpen: false }">
        ...
        <aside class="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0 bg-earth text-white">
            <div class="flex items-center gap-2.5 px-6 py-6">
                <img src="<?php echo e(asset('assets/mobile/icon.png')); ?>" alt="Tara Travel" class="w-8 h-8 rounded-[10px] object-cover shrink-0">
                <div>
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-2 space-y-6">
                <?php $__currentLoopData = $navSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
                        <p class="px-3 mb-1.5 text-[11px] font-mono uppercase tracking-widest text-white/35"><?php echo e($section); ?></p>
                            ...
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <a href="<?php echo e(route($item['route'])); ?>"
                                   class="flex items-center gap-2.5 rounded-md px-3 py-2 text-sm transition
                                          <?php echo e($active ? 'bg-white/10 text-white font-medium border-l-2 border-coral-500 -ml-px pl-[11px]' : 'text-white/65 hover:bg-white/5 hover:text-white'); ?>">
            ...
            <div class="px-3 py-4 border-t border-white/10">
                <div class="px-3 py-2 text-sm">
                    <p class="text-white/90 truncate"><?php echo e(auth('admin')->user()->name); ?></p>
                    <p class="text-white/40 text-xs truncate"><?php echo e(auth('admin')->user()->email); ?></p>
                </div>
            ...
            <header class="sticky top-0 z-30 bg-canvas/90 backdrop-blur border-b border-black/5">
                <div class="flex items-center justify-between px-4 lg:px-8 py-4">
                    <div class="flex items-center gap-3">
                        ...
                        <h1 class="text-lg font-semibold tracking-tight"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h1>
                    </div>
                    <?php if (! empty(trim($__env->yieldContent('header-actions')))): ?>
                        <div><?php echo $__env->yieldContent('header-actions'); ?></div>
                    <?php endif; ?>
                </div>
            </header>
...
<?php /**PATH D:\Spencer\Downloads\tara-admin\resources\views\admin\layouts\app.blade.php ENDPATH**/ ?>